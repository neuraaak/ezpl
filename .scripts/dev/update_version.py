...
"""Update the version badge in README.md and pyproject.toml from src/your-project/__init__.py.
...
def read_version() -> str:
    """Read version from src/{project_name}/__init__.py __version__.
    ...
    error_msg = f"Unable to find __version__ in src/{project_name.lower()}/__init__.py"
