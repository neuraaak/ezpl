...
"""
Generate architecture dependency graph for EzPl documentation.

Uses grimp to analyze the actual import graph of the ezpl package
...
LAYERS = ["cli", "core", "handlers", "config", "types", "utils"]
...
LAYER_STYLES = {
    ...
    "core": "fill:#5BA85A,color:#fff,stroke:#3A6B39",
    "handlers": "fill:#E8922A,color:#fff,stroke:#A3621B",
    "config": "fill:#9B59B6,color:#fff,stroke:#6C3483",
    "types": "fill:#E74C3C,color:#fff,stroke:#A93226",
    "utils": "fill:#7F8C8D,color:#fff,stroke:#566573",
}

LAYER_ROLES = {
    "cli": "Public entry point — Click CLI (`ezpl` command)",
    "core": "Main API (`Ezpl` singleton, `get_printer`, `get_logger`)",
    "handlers": "Concrete output handlers (`EzPrinter`, `EzLogger`, `RichWizard`)",
    "config": "Configuration management (`ConfigManager`, schema validation)",
    "types": "Type definitions — enums (`LogLevel`, `Pattern`), protocols, exceptions",
    "utils": "Pure utility functions (`safe_str_convert`, `sanitize_for_file`, …)",
}
