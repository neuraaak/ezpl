...
The `docs.yml` workflow automatically builds and deploys the **ezplog** documentation to GitHub Pages using **MkDocs Material**. The documentation is served at `https://neuraaak.github.io/ezplog/`.
...
1. **Visit documentation**: <https://neuraaak.github.io/ezplog/>
...
- **Preview URL**: <https://neuraaak.github.io/ezplog/>
...
site_url: https://neuraaak.github.io/ezplog/
theme:
  name: material
  features:
    - navigation.tabs
...
- **Live documentation**: <https://neuraaak.github.io/ezplog/>
